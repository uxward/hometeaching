		...
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<form id="familyForm">
						<div class="form-group">
							<label class="sr-only" for="familyName">Family Name</label> <input
								...
								name="familyName" placeholder="Family Name" maxlength="30" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="sr-only" for="phoneNumber">Phone Number</label> <input
								...
								name="phoneNumber" placeholder="Phone Number" maxlength="20" />
						</div>
						<div class="form-group">
							<label class="checkbox"> <input type="checkbox"
								name="moved" id="moved"> Moved
							</label>
						</div>
						<div class="form-group">
							<label class="checkbox"> <input type="checkbox"
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="saveFamily">Save
						Family</button>
				</div>
