...
<t:mainPage activeMenu="homeTeachers" pageTitle="Home Teachers" pageHeader="All" pageSubheader="Home Teachers">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="companionForm">
							...
							<input type="hidden" name="visitingTeaching" value="false" />
						</form>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="editCompanionForm">
							...
							<input type="hidden" name="visitingTeaching" value="false" /> <input type="hidden" name="id" id="editCompanionId" />
						</form>
					</div>
		...
		*/
		...
		function setupCompanionTable() {
			...
			$('#companionTable').dataTable({
				'sAjaxSource' : '<spring:url value="/companion/getHomeTeachingCompanions"/>',
				'aaData' : [],
				'aaSorting' : [ [ 0, 'asc' ] ],
				'aoColumns' : [ {
