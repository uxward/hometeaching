...
<t:mainPage activeMenu="visitingTeachingDetail" pageTitle="Visiting Teaching Landing" pageHeader="${person.fullName}'s" pageSubheader="Visiting Teaching">

	<div class="row">
		<div class="alert alert-info">
			<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
			<strong>Click which companionship you want to view!</strong><br /> It looks like you have multiple visiting teaching assignments. So which one do you want to see?
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function setupAssignmentTable() {
			$('#assignmentTable').dataTable({
				...
				'sAjaxSource' : '<spring:url value="/companion/getAllVisitingTeachingCompanions/"/>?personId=' + $('#assignmentTable').data('personId'),
				'aaData' : [],
				'aoColumns' : [ {
